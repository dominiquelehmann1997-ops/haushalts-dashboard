# HelloFresh-Gewürzmischungen — Zusammensetzung

Referenz für die Rezepte im Obsidian-Rezepte-Vault: viele HelloFresh-Gerichte
verwenden hauseigene Gewürzmischungen („Hello …"). Hier die Zusammensetzung der
einzelnen Mischungen (von den Tütchen abgeschrieben) plus kaufbare Alternativen —
zum Nachmischen oder Ersetzen, wenn das Tütchen leer ist.

Kursiv markierte Zutaten (z.B. *Senf*, *Sellerie*) sind deklarierte Allergene.
...
- **Hello Curry**
  ...
  - Alternative: [Just Spices Curry Madras](https://www.justspices.de/curry-madras.html)
...
## Verwendung im Rezepte-Vault

Im Rezepte-Vault liegt dieselbe Referenz als `_Gewürzmischungen HelloFresh.md`
(Unterstrich-Präfix ⇒ wird vom Dashboard-Ingest ignoriert, siehe
`recipe-vault-import-contract.md`). In Rezepten, die eine „Hello …"-Mischung
verwenden, steht die Zusammensetzung in Klammern hinter der Zutat — im
Markdown-Body, nicht im Frontmatter, damit Einkaufslisten-Einträge
(`syncIngredientsToShopping`) kurz bleiben.
